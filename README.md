...
# Betaflight - v4.5.5 AIRMOD Custom Version
...
```bash
git clone --recursive -b v4.5.5-airmod-custom https://github.com/Airmod-SAS/betaflight.git
cd betaflight
```
...
git checkout v4.5.5-airmod-custom
...
`obj/betaflight_4.5.5_AIRDRONEF405.hex`
