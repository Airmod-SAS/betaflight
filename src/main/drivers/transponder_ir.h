...
#elif defined(STM32F4) || defined(STM32F7) || defined(STM32H7) || defined(STM32G4) || defined(APM32F4) || defined(STM32H5)
...
typedef struct transponder_s {
    ...
    #if defined(STM32F4)|| defined(STM32F7) || defined(STM32H7) || defined(STM32G4) || defined(APM32F4) || defined(UNIT_TEST) || defined(STM32H5)
/// @todo [Project-H5] suppose to be like H7
